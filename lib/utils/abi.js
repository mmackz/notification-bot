module.exports = [
   ...
   { inputs: [], name: "OnlyOwnerCanCreate1155Quest", type: "error" },
   ...
   { inputs: [], name: "QuestTypeInvalid", type: "error" },
   ...
   },
   {
      inputs: [
         ...
         { internalType: "uint256", name: "rewardAmountOrTokenId_", type: "uint256" },
         { internalType: "string", name: "contractType_", type: "string" },
   ...
   },
   {
      inputs: [
         ...
         { internalType: "address", name: "rabbitHoleReceiptContract_", type: "address" },
         { internalType: "address", name: "rabbitHoleTicketsContract_", type: "address" },
         { internalType: "address", name: "protocolFeeRecipient_", type: "address" },
         { internalType: "address", name: "erc20QuestAddress_", type: "address" },
         { internalType: "address", name: "erc1155QuestAddress_", type: "address" },
   ...
   },
   {
      ...
      outputs: [{ internalType: "contract RabbitHoleTickets", name: "", type: "address" }],
      stateMutability: "view",
      type: "function"
   },
   {
   ...
   {
      inputs: [{ internalType: "address", name: "claimSignerAddress_", type: "address" }],
   ...
   {
      inputs: [{ internalType: "address", name: "erc1155QuestAddress_", type: "address" }],
   ...
   {
      inputs: [{ internalType: "address", name: "erc20QuestAddress_", type: "address" }],
   ...
   {
      inputs: [{ internalType: "address", name: "protocolFeeRecipient_", type: "address" }],
   ...
   },
   {
      ...
      name: "setRabbitHoleTicketsContract",
      outputs: [],
      stateMutability: "nonpayable",
      type: "function"
   },
